...
namespace ClearAction.Modules.UserAnalytics
{
    ...
    /// 
    /// Because the control inherits from ClearAction_UserAnalyticsSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : UserAnalyticsModuleSettingsBase
    {
                ...
                if (Page.IsPostBack == false)
                {
                    ...
                    */
                    if (Settings["Analytics_Mode"] != null)
                    {
                        ...
                        ddlDisplayMode.Items.FindByValue(_Mode).Selected = true;
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                modules.UpdateModuleSetting(ModuleId, "Analytics_Mode", ddlDisplayMode.SelectedValue);
                //tab module settings

...
namespace ClearAction.Modules.UserAnalytics.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        public override System.Data.IDataReader GetSolveSpaceAnalytics(int UserID)
        {
            return SqlHelper.ExecuteReader(ConnectionString, "CA_AnalyticalDataSS", UserID);
        }

        public override IDataReader GetUserAnalyticalData(int UserID, int ComponentTypeID)
        {
            return SqlHelper.ExecuteReader(ConnectionString, "CA_UserAnalyticalData", UserID, ComponentTypeID);
        }

        public override IDataReader GetUserActvityData(int UserID)
        {
            return SqlHelper.ExecuteReader(ConnectionString, "CA_UserComponentActivityData", UserID);
        }
        #endregion

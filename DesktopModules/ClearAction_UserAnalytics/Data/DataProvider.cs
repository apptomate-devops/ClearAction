...
namespace ClearAction.Modules.UserAnalytics.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "ClearAction.Modules.UserAnalytics.Data.SqlDataprovider,ClearAction_UserAnalytics";
        ...
        public abstract IDataReader GetSolveSpaceAnalytics(int userId);


        public abstract IDataReader GetUserAnalyticalData(int UserID, int ComponentTypeID);
        //public abstract IDataReader GetItem(int itemId);        

        public abstract IDataReader GetUserActvityData(int UserID);
        #endregion

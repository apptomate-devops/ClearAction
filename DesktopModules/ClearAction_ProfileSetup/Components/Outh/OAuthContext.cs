...
namespace ClearAction.Modules.ProfileClearAction_ProfileSetup.Components
{
    ...
    public class OAuthContext
    {
        ...
        public OAuthContext(string url)
        {
            CallbackUrl = url;// GetCallbackUrl("OAuthVerifier.aspx");//OAuthVerifier.aspx is a return url after login validation
        }

        public OAuthContext(string url, string _Consumerkey, string _ConsumerSecret)
        {
            CallbackUrl = url;
        ...
        /// </summary>
        public OAuthContext(string _Consumerkey, string _ConsumerSecret)
        {
            CallbackUrl = GetCallbackUrl("SocialLogin.aspx");
            ConsumerSecret = _ConsumerSecret;
            ConsumerKey = _Consumerkey;
        ...
        public void GetAccessToken()
        {
            ...
            try
            {
                ...
                using (var reader = new StreamReader(new MemoryStream(data)))
                {
                    ...
                    this.AccessToken = queryStrings["access_token"];
        ...
        public string ObtainVerifier(bool isreturn)
        {

            return HttpContext.Current.Server.UrlEncode(string.Format(VerifierUrl, this.ConsumerKey, this.CallbackUrl, this.Scope));
        }
        /// <summary>

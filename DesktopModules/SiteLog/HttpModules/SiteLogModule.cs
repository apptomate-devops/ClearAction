    ...
    public class SiteLogModule : IHttpModule
    {
        ...
        private void OnAuthorizeRequest(object sender, EventArgs e)
        {
            ...
            if (SiteLogHistory != 0)
            {
                ...
                try
                {
                    var userInfo = (DotNetNuke.Entities.Users.UserInfo)context.Items["UserInfo"];

                    iUserID = userInfo == null ? -1 : userInfo.UserID;
                }
                catch (Exception ex)
                {
                ...
                siteLogController.AddSiteLog(portalId, iUserID, urlReferrer, request.Url.ToString(),

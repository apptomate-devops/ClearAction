...
namespace ClearAction.Modules.ReportIssueClearAction_ReportIssue.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "ClearAction.Modules.ReportIssueClearAction_ReportIssue.Data.SqlDataprovider,ClearAction_ReportIssue";

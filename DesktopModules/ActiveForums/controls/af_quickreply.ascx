	...
	<tr>
		...
		<div id="groupQR" <%=DisplayMode%>><asp:PlaceHolder ID="plhMessage" runat="server" />
			<table width="100%"  cellspacing="0" cellpadding="4">
				...
				<tr>
					<td></td>
					<td class="NormalBold" colspan="2" style="display:none"> <input type="text" id="txtSubject" class="aftextbox" readonly="readonly" value="<%=Subject%>" /></td>
				...
				<tr>
					...
					<td width="100%" colspan="2">
						<textarea id="txtBody" name="txtBody" placeholder="Reply: Your thoughts" class="aftextboxreply" style="height:120px" rows="5" cols="250"></textarea>

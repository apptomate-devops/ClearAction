...
<table id="tblSearch" cellspacing="0" cellpadding="0" border="0" runat="server" >
	<tr>
		...
		<td><div class="afsearchgo"><asp:LinkButton id="lnkSearch"  runat="server" OnClick="lnkSearch_Click1"><img src="<%=ImagePath%>/images/search.gif" border="0" alt="[RESX:Search]" /></asp:LinkButton></div></td>
	</tr>
</table>
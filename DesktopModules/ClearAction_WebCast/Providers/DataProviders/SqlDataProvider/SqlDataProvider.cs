...
namespace ClearAction.Modules.WebCast.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "ClearAction_WebCast_";
        ...
        //}
        public void UpdateTopicSeenStatus(int UserID, int ItemID, int ComponentTypeID)
        {
            SqlHelper.ExecuteNonQuery(_connectionString, "CA_SaveUserVisit", UserID, ItemID, ComponentTypeID);
        }

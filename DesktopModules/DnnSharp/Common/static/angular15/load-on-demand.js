...
(function (angular) {
    ...
    aModule.directive('loadOnDemand', ['$http', 'scriptCache', '$log', '$loadOnDemand', '$compile', '$timeout', '$injector',
        function ($http, scriptCache, $log, $loadOnDemand, $compile, $timeout, $injector) {
            return {
                replace: false,
                link: {
                    pre: function (scope, element, attr) {
                        ...
                        function reCompileDirective(moduleName) {
                            ...
                            var checkIfCompiled = setInterval(function () {
                                ...
                                sc.$apply();
                                if ($injector.has(moduleName + 'Directive'))
                                    $timeout(clearInterval(checkIfCompiled));
                            }, 100)
                        }
                    },

...
namespace ClearAction.Modules.ComponentManager
{
    ...
    /// 
    /// Because the control inherits from ClearAction_ComponentManagerSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : ComponentManagerModuleSettingsBase
    {

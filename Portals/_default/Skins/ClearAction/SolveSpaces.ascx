...
<dnn:DnnCssInclude runat="server" FilePath="~/Portals/_default/Skins/ClearAction/Css/style.css" />
<dnn:DnnCssInclude runat="server" FilePath="~/Portals/_default/Skins/ClearAction/Css/responsive.css" />

<dnn:DnnJsInclude runat="server" FilePath="~/Portals/_default/Skins/ClearAction/Js/isotope.pkgd.min.js" />
<dnn:DnnJsInclude runat="server" FilePath="~/Portals/_default/Skins/ClearAction/Js/main.js" />
<dnn:DnnJsInclude runat="server" FilePath="~/Portals/_default/Skins/ClearAction/Js/jquery.matchHeight.js" />
    ...
    <div class="">
        <main role="main">
            ...
            <div id="mainContent-inner">
                ...
                <div class="row dnnpane">
                    <div id="P1_75_1" class="col-md-9 spacingTop" runat="server"></div>
                    <div id="P1_25_2" class="col-md-3 spacingTop" runat="server"></div>
                </div>
